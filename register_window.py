...
personal_info_frame = tk.LabelFrame(frame, text="Personal Information", font=("Arial", 32, "bold"))
personal_info_frame.pack(padx=10, pady=10, fill="both", expand=True)


firstname_label = tk.Label(personal_info_frame, text="First Name:", font=("Arial", 32))
...
lastname_label = tk.Label(personal_info_frame, text="Last Name:", font=("Arial", 32))
...
age_label = tk.Label(personal_info_frame, text="Age:", font=("Arial", 32))
age_label.grid(row=2, column=0, sticky="w", padx=10, pady=10)
age_entry = tk.Entry(personal_info_frame, width=50, font=("Arial", 32))
age_entry.grid(row=2, column=1, padx=10, pady=10)

sex_label = tk.Label(personal_info_frame, text="Sex:", font=("Arial", 32))
sex_label.grid(row=3, column=0, sticky="w", padx=10, pady=10)
...
birthday_label = tk.Label(personal_info_frame, text="Birthday:", font=("Arial", 32))
birthday_label.grid(row=4, column=0, sticky="w", padx=10, pady=10)
...
contact_info_frame = tk.LabelFrame(frame, text="Contact Information", font=("Arial", 32, "bold"))
contact_info_frame.pack(padx=10, pady=10, fill="both", expand=True)

address_label = tk.Label(contact_info_frame, text="Address:", font=("Arial", 32))
address_label.grid(row=0, column=0, sticky="w", padx=10, pady=10)
address_entry = tk.Entry(contact_info_frame, width=50, font=("Arial", 32))
address_entry.grid(row=0, column=1, padx=10, pady=10)

contact_number_label = tk.Label(contact_info_frame, text="Contact Number:", font=("Arial", 32))
contact_number_label.grid(row=1, column=0, sticky="w", padx=10, pady=10)
...
emergency_contact_name_label = tk.Label(contact_info_frame, text="Emergency Contact Name:", font=("Arial", 32))
emergency_contact_name_label.grid(row=2, column=0, sticky="w", padx=10, pady=10)
...
emergency_contact_number_label = tk.Label(contact_info_frame, text="Emergency Contact Number:", font=("Arial", 32))
emergency_contact_number_label.grid(row=3, column=0, sticky="w", padx=10, pady=10)
...
marital_status_label = tk.Label(contact_info_frame, text="Marital Status:", font=("Arial", 32))
marital_status_label.grid(row=6, column=0, sticky="w", padx=10, pady=10)
